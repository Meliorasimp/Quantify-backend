...
namespace EnterpriseGradeInventoryAPI.GraphQL
{
  public class Mutation : ObjectType
  {
    protected override void Configure(IObjectTypeDescriptor descriptor)
    {
      ...
      descriptor.Field<InventoryMutation>(t => t.AddInventory(default!, default!, default!, default!))
        .Name("addInventory")
        .Description("Add a new Inventory Item");
      descriptor.Field<InventoryMutation>(t => t.DeleteInventory(default!, default!, default!, default!))
        .Name("deleteInventory")
        .Description("Delete an Inventory Item");
      descriptor.Field<InventoryMutation>(t => t.UpdateInventory(default!, default!, default!, default!, default!, default!, default!, default!, default!))
        .Name("updateInventory")
        .Description("Update an Inventory Item");
      descriptor.Field<WarehouseMutation>(t => t.addWarehouse(default!, default!, default!))
        .Name("addWarehouse")
        .Description("Add a new Warehouse");
      descriptor.Field<StorageLocationMutation>(t => t.addStorageLocation(
          default!,
          default!,
          default!,
          default!
